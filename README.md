...
```r
Out_split <- split_data(data = df_AutoScore, ratio = c(6, 2, 2))
...
```r
test_result<-AutoScore_testing(TestSet,Score_adjusted_weight[[1]],Score_adjusted_weight[[2]],Score_adjusted_weight[[3]])
```
